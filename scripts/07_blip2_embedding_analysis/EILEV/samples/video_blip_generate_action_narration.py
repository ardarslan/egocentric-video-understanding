...
if __name__ == "__main__":
    ...
    parser.add_argument("--video", default=os.path.join(os.environ["CODE"], "scripts/07_blip2_embedding_analysis/EILEV/demo/examples/bike-fixing-0.mp4"), type=str)
    parser.add_argument("--prompt", default="What is the camera wearer doing?", type=str)
    parser.add_argument("--model", default=os.path.join(os.environ["SCRATCH"], "mq_libs/video-blip-opt-2.7b-ego4d"))
