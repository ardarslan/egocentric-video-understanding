...
if __name__ == "__main__":
    compare_anno(
        f"{os.environ['CODE']}/scripts/08_reproduce_mq_experiments/data/ego4d/ego4d_clip_annotations_v3.json",
        f"{os.environ['CODE']}/scripts/08_reproduce_mq_experiments/data/ego4d/ego4d_clip_annotations.json",
    )
