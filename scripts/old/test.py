...
from libs.utils import valid_one_epoch, ANETdetection, fix_random_seed, infer_one_epoch
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="train_on_train_split_checkpoints/ego4d_asl_features/epoch_011.pth.tar",
