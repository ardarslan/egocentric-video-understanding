...
parser.add_argument(
    "--in_dir",
    default="/mnt/session_space/home/lingzzha/EgoHOS/data/train/label_foreground_512",
    type=str,
)
parser.add_argument(
    "--out_dir",
    default="/mnt/session_space/home/lingzzha/EgoHOS/data/train/label_foreground_512_pad",
    type=str,
)
parser.add_argument(
    "--pad_info_dir",
    default="/mnt/session_space/home/lingzzha/EgoHOS/data/train/label_foreground_512_pad_info",
    type=str,
)
...
for img_file in tqdm(glob.glob(args.in_dir + "/*")):
    ...
    np.save(
        os.path.join(args.pad_info_dir, str(fname.split(".")[0]) + ".npy"), pad_info
    )
