...
parser.add_argument(
    "--input_video_file", default="../testvideos/testvideo1_short.mp4", type=str
)
parser.add_argument(
    "--output_video_file", default="../testvideos/testvideo1_short_result.mp4", type=str
)
parser.add_argument(
    "--twohands_config_file",
    default="./work_dirs/seg_twohands_ccda/seg_twohands_ccda.py",
    type=str,
)
parser.add_argument(
    "--twohands_checkpoint_file",
    default="./work_dirs/seg_twohands_ccda/best_mIoU_iter_56000.pth",
    type=str,
)
parser.add_argument(
    "--cb_config_file",
    default="./work_dirs/twohands_to_cb_ccda/twohands_to_cb_ccda.py",
    type=str,
)
parser.add_argument(
    "--cb_checkpoint_file",
    default="./work_dirs/twohands_to_cb_ccda/best_mIoU_iter_76000.pth",
    type=str,
)
parser.add_argument(
    "--obj1_config_file",
    default="./work_dirs/twohands_cb_to_obj1_ccda/twohands_cb_to_obj1_ccda.py",
    type=str,
)
parser.add_argument(
    "--obj1_checkpoint_file",
    default="./work_dirs/twohands_cb_to_obj1_ccda/best_mIoU_iter_34000.pth",
    type=str,
)
parser.add_argument(
    "--obj2_config_file",
    default="./work_dirs/twohands_cb_to_obj2_ccda/twohands_cb_to_obj2_ccda.py",
    type=str,
)
parser.add_argument(
    "--obj2_checkpoint_file",
    default="./work_dirs/twohands_cb_to_obj2_ccda/best_mIoU_iter_32000.pth",
    type=str,
)
parser.add_argument("--remove_intermediate_images", default=False, type=bool)
args = parser.parse_args()

video_dir = args.input_video_file.split(".mp4")[0]
...
video_obj2_dir = os.path.join(video_dir, "pred_obj2")
os.makedirs(video_obj2_dir, exist_ok=True)
...
cmd_pred_cb = (
    "python predict_image.py \
                    ...
                    --img_dir %s \
                    --pred_seg_dir %s"
    % (args.cb_config_file, args.cb_checkpoint_file, video_image_dir, video_cb_dir)
)
...
if args.mode == "obj1":
    ...
    cmd_pred_obj2 = (
        "python predict_image.py \
                        ...
                        --pred_seg_dir %s"
        % (
            args.obj2_config_file,
            args.obj2_checkpoint_file,
            video_image_dir,
            video_obj2_dir,
        )
    )
