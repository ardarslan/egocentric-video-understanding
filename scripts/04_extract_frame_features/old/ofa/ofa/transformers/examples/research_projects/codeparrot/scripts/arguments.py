...
class TrainingArguments:
    ...
    max_train_steps: Optional[int] = field(
        default=50_000, metadata={"help": "Maximum number of training steps."}
    )
...
class TokenizerTrainingArguments:
    ...
    vocab_size: Optional[int] = field(
        default=200000, metadata={"help": "Number of examples to train tokenizer on."}
    )
