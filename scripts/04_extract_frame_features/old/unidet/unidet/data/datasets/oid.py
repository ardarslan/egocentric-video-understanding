...
_PREDEFINED_SPLITS_OID = {
    "oid_train": (
        "oid/images/train/",
        "oid/annotations/oid_challenge_2019_train_bbox.json",
    ),
    "oid_val": (
        "oid/images/validation/",
        "oid/annotations/oid_challenge_2019_val.json",
    ),
    "oid_val_expanded": (
        "oid/images/validation/",
    ...
    "oid_kaggle_test": (
        "oid/images/test/",
        "oid/annotations/oid_kaggle_test_image_info.json",
    ),
}
...
_PREDEFINED_SPLITS_OID_SEG = {
    "oid_seg_train": (
        "oid/images/train/",
        "oid/annotations/openimages_instances_train.json",
    ),
    "oid_seg_val": (
        "oid/images/validation/",
        "oid/annotations/openimages_instances_val.json",
    ),
    "oid_seg_kaggle_test": (
        "oid/images/test/",
