...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="$CODE/scripts/04_extract_frame_features/unidet/configs/Unified_learned_OCIM_R50_6x+2x.yaml",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="$CODE/scripts/04_extract_frame_features/visor_hos/configs/hos_pointrend_rcnn_R_50_FPN_1x.yaml",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="$CODE/scripts/04_extract_frame_features/gsam/gsam/GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py",
        help="path to config file",
    )
    parser.add_argument(
        "--gsam_grounding_model_file_path",
        type=str,
        default="$SCRATCH/mq_libs/gsam/groundingdino_swint_ogc.pth",
        help="path to checkpoint file",
    )
    parser.add_argument(
        "--gsam_ram_model_file_path",
        type=str,
        default="$SCRATCH/mq_libs/gsam/ram_swin_large_14m.pth",
        help="path to checkpoint file",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="$CODE/scripts/04_extract_frame_features/ego_hos/configs/seg_twohands_ccda.py",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="$CODE/scripts/04_extract_frame_features/ego_hos/configs/twohands_to_cb_ccda.py",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="$CODE/scripts/04_extract_frame_features/ego_hos/configs/twohands_cb_to_obj2_ccda.py",
    )
    parser.add_argument(
