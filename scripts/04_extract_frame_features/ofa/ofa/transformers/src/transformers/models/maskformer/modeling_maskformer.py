...
class MaskFormerHungarianMatcher(nn.Module):
    ...
    def forward(
        ...
        mask_labels = nn.functional.interpolate(
            mask_labels, size=preds_masks.shape[-2:], mode="nearest"
        )
