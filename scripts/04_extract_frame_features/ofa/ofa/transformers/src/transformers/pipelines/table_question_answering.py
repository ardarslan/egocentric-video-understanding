...
class TableQuestionAnsweringPipeline(Pipeline):
    ...
    def __init__(
        ...
        self.aggregate = bool(
            getattr(self.model.config, "aggregation_labels")
        ) and bool(getattr(self.model.config, "num_aggregation_labels"))
    ...
    def _forward(self, model_inputs, sequential=False):
        ...
        outputs = (
            self.sequential_inference(**model_inputs)
            if sequential
            else self.batch_inference(**model_inputs)
        )
        model_outputs = {
