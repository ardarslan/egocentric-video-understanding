...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES RAY_DEDUP_LOGS=0 python3 01_extract_frame_features.py --frame_feature_name $FRAME_FEATURE_NAME --quarter_index $QUARTER_INDEX
