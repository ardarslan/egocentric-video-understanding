...
data = dict(
    ...
    train=dict(
        ...
        ann_dir="train/label_contact_ccda",
        pipeline=[
            dict(type="LoadImageFromFile"),
            ...
            dict(type="Pad", size=(360, 480), pad_val=0, seg_pad_val=255),
    ...
    val=dict(
        ...
        ann_dir="test_outdomain/label_contact",
        pipeline=[
            dict(type="LoadImageFromFile"),
            dict(
                type="MultiScaleFlipAug",
    ...
    test=dict(
        ...
        ann_dir="test_indomain/label_contact",
        pipeline=[
            dict(type="LoadImageFromFile"),
            dict(
                type="MultiScaleFlipAug",
...
work_dir = "./work_dirs/twohands_to_cb_ccda"
gpu_ids = range(0, 8)
auto_resume = False

additional_channel = "twohands"  # NONE, twohands, twohands_cb
