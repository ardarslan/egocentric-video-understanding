...
class BaseSegmentor(BaseModule, metaclass=ABCMeta):
    ...
    @abstractmethod
    def simple_test(self, img, img_meta, previous_results, **kwargs):
        """Placeholder for single image test."""
        pass

    @abstractmethod
    def aug_test(self, imgs, img_metas, previous_results, **kwargs):
        """Placeholder for augmentation test."""
        pass

    def forward_test(self, imgs, img_metas, previous_results, **kwargs):
        """
        Args:
        ...
        if num_augs == 1:
            return self.simple_test(imgs[0], img_metas[0], previous_results, **kwargs)
        else:
            return self.aug_test(imgs, img_metas, previous_results, **kwargs)

    @auto_fp16(apply_to=("img",))
    def forward(self, img, img_metas, previous_results, return_loss=True, **kwargs):
        ...
        """
        if return_loss:
            return self.forward_train(img, img_metas, previous_results, **kwargs)
        else:
            return self.forward_test(img, img_metas, previous_results, **kwargs)
