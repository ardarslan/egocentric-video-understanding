_base_ = [
    ...
    "../_base_/datasets/egohos_handobj2_subset.py",
...
model = dict(
    ...
    decode_head=dict(in_channels=[128, 256, 512, 1024], num_classes=9),
    auxiliary_head=dict(in_channels=512, num_classes=9),
)
...
evaluation = dict(
    interval=2000, metric=["mIoU", "mFscore"], pred_eval=True, save_best="mIoU"
)
