...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mode",
        default="twohands_obj1",
        type=str,
        help="options: twohands, cb, twohands_obj1, twohands_obj2",
    )
    parser.add_argument(
        "--img_dir",
        default="/mnt/session_space/home/lingzzha/EgoHOS/testimages/images",
        type=str,
    )
    parser.add_argument(
        "--twohands_dir",
        default="/mnt/session_space/home/lingzzha/EgoHOS/testimages/pred_twohands",
        type=str,
    )
    parser.add_argument(
        "--cb_dir",
        default="/mnt/session_space/home/lingzzha/EgoHOS/testimages/pred_cb",
        type=str,
    )
    parser.add_argument(
        "--obj1_dir",
        default="/mnt/session_space/home/lingzzha/EgoHOS/testimages/pred_obj1",
        type=str,
    )
    parser.add_argument(
        "--obj2_dir",
        default="/mnt/session_space/home/lingzzha/EgoHOS/testimages/pred_obj2",
        type=str,
    )
    parser.add_argument(
        "--vis_dir",
        default="/mnt/session_space/home/lingzzha/EgoHOS/testimages/pred_obj1_vis",
        type=str,
    )
    ...
    for img_file in glob.glob(args.img_dir + "/*"):
        ...
        if args.mode == "twohands":
            twohands = np.array(
                Image.open(os.path.join(args.twohands_dir, fname + ".png"))
            )
