...
if __name__ == "__main__":
    ...
    for lbl_type in lbl_type_list:
        ...
        dst_img_dir = img_dir + "_downsize"
        os.makedirs(dst_img_dir, exist_ok=True)
        dst_lbl_dir = lbl_dir + "_downsize"
        os.makedirs(dst_lbl_dir, exist_ok=True)
        dst_lbl_allhands_dir = lbl_allhands_dir + "_downsize"
        os.makedirs(dst_lbl_allhands_dir, exist_ok=True)
        dst_lbl_twohands_dir = lbl_twohands_dir + "_downsize"
        os.makedirs(dst_lbl_twohands_dir, exist_ok=True)
        dst_lbl_handobj1_dir = lbl_handobj1_dir + "_downsize"
        os.makedirs(dst_lbl_handobj1_dir, exist_ok=True)
