...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            os.environ["SCRATCH"],
            "ego4d_data/v2/analysis_data",
            "clip_id_frame_id_predicted_label_indices_and_scores_nontemporal_dictionary_matching.pickle",
        ),
    )
    ...
    clip_id_frame_id_predicted_label_indices_and_scores_nontemporal_dictionary_matching = dict(
        pqdm(
            [
                {
                    "clip_id": clip_id,
                ...
                for clip_id, frame_id_blip2_question_answer_verb_noun_tool_pairs_mapping in clip_id_frame_id_verb_noun_tool_pairs_mapping.items()
            ],
