    ...
    for (
        ...
        for (
            ...
            for score_tuple in score_tuples:
                if (
                    query_score_type == "max_of_max_of_all"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--clip_id_frame_id_predicted_label_indices_and_scores_file_path",
        type=str,
    ...
    with open(
        args.clip_id_frame_id_predicted_label_indices_and_scores_file_path, "rb"
    ) as reader:
