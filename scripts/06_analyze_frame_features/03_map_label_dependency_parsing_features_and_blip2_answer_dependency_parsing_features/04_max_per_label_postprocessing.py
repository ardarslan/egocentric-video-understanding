...
def max_per_label_postprocessing_per_clip(
    clip_id: str,
    frame_id_blip2_question_index_label_index_scores_mapping: Dict[int, Dict[int, List[Tuple[int, float]]]],
    ...
    for (
        ...
        for blip2_question_index, label_index_scores_mapping in blip2_question_index_label_index_scores_mapping.items():
            frame_id_blip2_question_index_label_index_max_score_mapping[frame_id][blip2_question_index] = dict()
            sum_max_scores = 0.0
            for label_index, score_tuples in label_index_scores_mapping.items():
                ...
                frame_id_blip2_question_index_label_index_max_score_mapping[frame_id][blip2_question_index][label_index] = (constant_with_maximum_score, max_score)
                sum_max_scores += max_score

            for label_index in frame_id_blip2_question_index_label_index_max_score_mapping[frame_id][blip2_question_index].keys():
                frame_id_blip2_question_index_label_index_max_score_mapping[frame_id][blip2_question_index][label_index] = (
                    frame_id_blip2_question_index_label_index_max_score_mapping[frame_id][blip2_question_index][label_index][0],
                    frame_id_blip2_question_index_label_index_max_score_mapping[frame_id][blip2_question_index][label_index][1] / sum_max_scores,
                )
