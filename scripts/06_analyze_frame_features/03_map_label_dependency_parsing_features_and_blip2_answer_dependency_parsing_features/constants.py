...
question_constant_mapping = {
    ...
    # "What is the object that the person is interacting with in this picture?": 3, # CHANGEHERE
    # "What action the person in this picture is doing?": 4, # CHANGEHERE
    # "This picture was taken with a camera mounted on the head of a person. What is this person doing?": 5, # CHANGEHERE
    "asl": 6,
}
