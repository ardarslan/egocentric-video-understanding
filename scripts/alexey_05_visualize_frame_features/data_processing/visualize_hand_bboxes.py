...
def main(arg_dict=None):
    ...
    parser.add_argument("--input_dir", type=str,
                        default=join(ROOT_PATH, "data", "EK_hand_bboxes"))
    ...
    parser.add_argument("--output_dir", type=str, default=join(ROOT_PATH, "data", "EK_hand_bbox_vis"))
        ...
        for frame_data in tqdm(gen):
            ...
            for hand, color in [("left_hand", "blue"), ("right_hand", "red")]:
                if hand in hand_data and hand_data[hand] is not None:
                    d = hand_data[hand]
                    draw.rectangle((d[0], d[1], d[0] + d[2], d[1] + d[3]), outline=color, width=2)
